...
public class PayslipDetailDialog extends JDialog {
    public PayslipDetailDialog(Window owner, Payroll p) {
        ...
        try {
            ...
            double personal = PayrollCalculator.PERSONAL_DEDUCTION;
            double dependent = dependents * PayrollCalculator.DEPENDENT_DEDUCTION;
            double taxable = PayrollCalculator.taxableIncome(gross, insurance, dependents);
            double pit = PayrollCalculator.pit(taxable);
            ...
            String[][] rows = {
                ...
                {"Giảm trừ NPT ("+dependents+" người × 6.200.000)", money(dependent)},
            ...
            JLabel note=new JLabel("BH bắt buộc = 10,5% lương đóng BHXH; PIT tính theo biểu thuế lũy tiến 2026.");
